...
function _deriveProviderOperation(providerName, provider, item) {
  ...
  return {
    ...
    definition: {prerequisites: provider.prerequisites.slice(), requirements: provider.requirements.slice(), action: substituteAction, when: null, outputs: {}, failure: 'stop', incremental: null},
