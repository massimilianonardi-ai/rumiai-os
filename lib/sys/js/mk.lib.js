...
function _normalizeProfiles(value, version) {
  ...
  for (const name of Object.keys(value)) {
    ...
    const allowed = version === 1
      ...
      : new Set(['environment', 'goals', 'operations', 'collections', 'providers', 'dependencies']);
...
function _loadProjectConfig(configPath) {
  ...
  const allowed = version === 1
    ...
    : new Set(['version', 'environment', 'goals', 'operations', 'profiles', 'collections', 'providers', 'dependencies']);
