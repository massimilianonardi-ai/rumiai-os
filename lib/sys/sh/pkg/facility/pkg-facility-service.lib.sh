...
_pkg_facility_service_provider_validate()
{
  [ "$#" -eq 4 ] || return 2
  pkg_facility_service_contract=$1
  pkg_facility_service_realization=$2
  pkg_facility_service_definition=$3
  pkg_facility_service_root=$4

  _pkg_facility_service_contract_validate "$pkg_facility_service_contract" || return 1
  ...
  _pkg_facility_service_scalar_read "$pkg_facility_service_realization/start" || return 1
